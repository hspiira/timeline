  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        Drag nodes from the palette onto the canvas. Connect nodes from source (bottom) to target (top) handles.
        Condition nodes have two outputs: true (green) and false (red). Exactly one trigger and no orphan nodes required.
      </p>
      <WorkflowBuilder
