...
/**
 * Determines if the current user has subject export permission.
 * Used to hide the Export button on subject detail when the user lacks permission.
 *
 * TODO: When backend exposes permissions (e.g. in /auth/me or a safe probe endpoint
 * that returns 403 when lacking subject.export), implement a real check here.
