...
const iconMap: Record<string, SubjectTypeTheme> = {
  user: {
    ...
    headerBg: 'bg-gradient-to-r from-blue-50/50 to-blue-100/30 dark:from-blue-950/20 dark:to-blue-900/10',
  },
  users: {
    icon: Users,
    bgColor: 'bg-blue-100 dark:bg-blue-900/20',
  ...
  customer: {
    ...
    headerBg: 'bg-gradient-to-r from-purple-50/50 to-purple-100/30 dark:from-purple-950/20 dark:to-purple-900/10',
  },
  order: {
    icon: ShoppingCart,
    ...
    headerBg: 'bg-gradient-to-r from-green-50/50 to-green-100/30 dark:from-green-950/20 dark:to-green-900/10',
  },
  project: {
    icon: FolderKanban,
    ...
    headerBg: 'bg-gradient-to-r from-orange-50/50 to-orange-100/30 dark:from-orange-950/20 dark:to-orange-900/10',
  },
  invoice: {
    icon: FileText,
    ...
    headerBg: 'bg-gradient-to-r from-amber-50/50 to-amber-100/30 dark:from-amber-950/20 dark:to-amber-900/10',
  },
  shipment: {
    icon: Package,
    ...
    headerBg: 'bg-gradient-to-r from-cyan-50/50 to-cyan-100/30 dark:from-cyan-950/20 dark:to-cyan-900/10',
  },
  package: {
    icon: Package,
    bgColor: 'bg-cyan-100 dark:bg-cyan-900/20',
...
const defaultTheme: SubjectTypeTheme = {
  ...
  headerBg: 'bg-gradient-to-r from-gray-50/50 to-gray-100/30 dark:from-gray-950/20 dark:to-gray-900/10',
}
