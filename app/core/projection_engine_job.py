...
async def run_projection_engine_job(app: FastAPI) -> None:
        ...
        try:
            async with AsyncSessionLocal() as db:
                async with db.begin():
                    ...
                    def subject_repo_factory(tenant_id: str):
                    ...
                    engine = ProjectionEngine(
                        ...
                        subject_repo_factory=subject_repo_factory,
                        registry=registry,
                        interval_seconds=interval,
                        batch_size=batch_size,
                    )
                    await engine._advance_all()
